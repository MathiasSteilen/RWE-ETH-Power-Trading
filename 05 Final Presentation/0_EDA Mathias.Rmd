...
The goal of this EDA is to better understand our target variables (spot prices and auction prices).

```{r}
# Read data
df = read_csv("../00 Data Retrieval and Cleaning/0_df_final_not_imputed.csv") |> 
  arrange(date)
