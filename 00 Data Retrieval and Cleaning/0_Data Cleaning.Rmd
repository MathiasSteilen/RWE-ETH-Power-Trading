...
df_predictive = df |> 
  mutate(
    across(c(
      ...
      fossil_coal_derived_gas_actual_aggregated_it_missing_dummy,
...
df_theoretical = df |> 
  ...
  select(-c(
    solar_forecast_de, solar_forecast_de_missing_dummy, 
    wind_onshore_forecast_fr, wind_onshore_forecast_fr_missing_dummy
  ))
