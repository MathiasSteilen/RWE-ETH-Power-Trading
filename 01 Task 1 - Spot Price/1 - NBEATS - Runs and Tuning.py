...
output_folders = [
  "./1 - NBEATS - Prediction - CH - Data Predictive/",
  "./1 - NBEATS - Prediction - CH - Data Theoretical/",
  "./1 - NBEATS - Prediction - DE - Data Predictive/",
  "./1 - NBEATS - Prediction - DE - Data Theoretical/"
]
